...
final class TextRecognizerTests: XCTestCase {
    func testScanImageSuccess() throws {
        let expectation = expectation(description: "testScanImageSuccess")
        Task {
            let fileURL = try XCTUnwrap(Bundle.module.url(forResource: "ImageTest", withExtension: "png"))
    ...
    func testScanImageFailedZeroDimensionedImage() throws {
        let expectation = expectation(description: "testScanImageSuccess")
        Task {
            do {
    ...
    func testScanImageFailedWrongROI() throws {
        let expectation = expectation(description: "testScanImageSuccess")
        Task {
            do {
